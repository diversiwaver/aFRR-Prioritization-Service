...
internal class TestPrioritizationModel
{
    ...
    [TestCase("v1", 999), TestCase("v1", 30), TestCase("v1", 12), TestCase("v1", 4), TestCase("v1", 23.33), TestCase("v1", 0)]
    [Test]
    public void PrioritizationModel_ShouldGetPrioritizedAssets_WhenGivenSignalAndThreshold(string modelVersion, decimal threshold)
    {
        ...
        IEnumerable<AssetDTO> retrievedAssets;
        decimal totalRegulatedCapacity;
        ...
        // Arrange
        Assert.That(totalRegulatedCapacity, Is.EqualTo(threshold));
    }
}
